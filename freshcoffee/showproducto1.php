                ...
                <div class="shg-c-lg-12 " style="background-color:#F7F5EF; padding:10px;">
                    <!--...Product Image...-->
                        <div class="shg-c shogun-image-container  shogun-image-linked  shg-align-center" style="" >
                            <img class="lazyautosizes lazyloaded" src="<?php echo $theruta.constant('Product1_Image'); ?>">
                        </div>
                    </a>
                </div>

                <!--...Quick Add Button...-->
                <div class="shg-c-lg-12 " style="text-align:center; width:100%">





                <div id='product-component-1679677554481' style="text-align:center; width:100%; margin: 0 auto;"></div>
  ...
  function ShopifyBuyInit() {
    ...
    ShopifyBuy.UI.onReady(client).then(function (ui) {
      ui.createComponent('product', {
        id: '8056436949309',
        node: document.getElementById('product-component-1679677554481'),
